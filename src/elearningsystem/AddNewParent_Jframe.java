 ...
 * @author Amr
 */
public class AddNewParent_Jframe extends javax.swing.JFrame {

    /**
     * Creates new form Home_Jframe
     */
    public AddNewParent_Jframe() {
        initComponents();
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        db.addParent(id, Name, email, phone, add);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewParent_Jframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddNewParent_Jframe().setVisible(true);
            }
        });
    }
